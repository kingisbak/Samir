...
os.system('espeak -a 300 "Welcome to  hacker 999 tool this tool created by NAHID "')

print("\033[1;92m   [•] WELCOME TO  HACKER 999 TOOL THIS TOOL CREATED BY NAHID  \033[1;30m")

os.system('espeak -a 300 "Subscribe  My YouTube channel "')

print("\033[1;92m   [•] SUBSCRIBE MY YOUTUBE CHANNEL\033[1;30m")

os.system('xdg-open https://youtube.com/@mdnahidjr-bc8oe?si')
